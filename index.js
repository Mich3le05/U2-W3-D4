...
// // Event listener per "Load Images" con query da campo di ricerca
// imgLoadButton.addEventListener('click', (e) => {
//   e.preventDefault()
//   const query = searchQueryInput.value || 'cars'
//   loadImages(query)
// })
